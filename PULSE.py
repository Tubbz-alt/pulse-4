...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=13ucp7AR4ucYrsMf-8etWxZk1MTGAcPIF", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            # mapping.pt
            with open_url("https://drive.google.com/uc?id=1CGJf_11_SotYL9HeFEhzXrYV4nyVGGrc", cache_dir=cache_dir, verbose=verbose) as f:
